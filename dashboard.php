...
<body>
    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="" data-toggle="modal" data-target="#akun">Akun</a></li>
        </ul>
      </nav>
    </div>
  </header>
  ...
  <section id="hero">
    <div class="hero-container">
      ...
      <div id="tandatangan" class="modal fade" role="dialog">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title"><b>Tambah Tanda Tangan</b></h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body" style="height:300px;">
              <iframe src="config/signature.php" style="position:relative; top:0; left:0; bottom:0; right:0; width:100%; height:100%; border:none; margin:0; padding:0; z-index:999999;"></iframe>
            </div>
            <div class="modal-footer">
              <a href="dashboard.php"><input type="button" class="btn btn-danger" value="Tutup"/></a>
            </div>
          </div>
        </div>
      </div>

      <div id="akun" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title"><b>Akun Saya</b></h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            ...
            <table class="table table-borderless table-sm">
              <tbody>
                ...
                <tr>
                  <th scope="row">Tanda Tangan</th>
                  <td>:</td>
                  <td>
                  <?php
                  if ($row['img'] == "") {
        
                    $error_message = "Mohon Atur Tanda Tangan.";
                    echo $error_message;
                  } 
                  else{
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-outline-primary" data-dismiss="modal" data-toggle="modal" data-target="#tandatangan">Atur Tanda Tangan</button>
              <a href="config/logout.php"><input type="button" class="btn btn-danger" value="Keluar"/></a>
            </div>
          </div>
        </div>
      </div>
              ...
              <div id="myModal1" class="modal fade" role="dialog">
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button onclick="window.open('https://api.whatsapp.com/send?phone=6282112320069&text=Halo%20saya%20ingin%20memesan%20paket%20engagement%20kalian')" type="button" class="btn-1" data-dismiss="modal">Pesan</button>
              ...
              <div id="myModal2" class="modal fade" role="dialog">
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button onclick="window.open('https://api.whatsapp.com/send?phone=6282112320069&text=Halo%20saya%20ingin%20memesan%20paket%20pra%20wedding%20kalian')" type="button" class="btn-1" data-dismiss="modal">Pesan</button>
                      <button type="button" class="btn-1-close" data-dismiss="modal">Tutup</button>
                    </div>
                  </div>
                </div>
              ...
              <div id="myModal3" class="modal fade" role="dialog">
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button onclick="window.open('https://api.whatsapp.com/send?phone=6282112320069&text=Halo%20saya%20ingin%20memesan%20paket%20wedding%20kalian')" type="button" class="btn-1" data-dismiss="modal">Pesan</button>
                      <button type="button" class="btn-1-close" data-dismiss="modal">Tutup</button>
                    </div>
                  </div>
                </div>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <div class="info">
              ...
              <div>
                <a
                href="" onclick="window.open('https://api.whatsapp.com/send?phone=6282112320069&text=Halo%20saya%20ingin%20memesan%20paket%20kalian')"><i
